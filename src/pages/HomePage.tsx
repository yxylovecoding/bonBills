  ...
  return (
    <div>
      ...
      <Card title="FIRE 提前退休" subtitle="4% 法则">
        ...
        <StatRow label="预估个税" value={<span style={{ fontVariantNumeric: 'tabular-nums', fontWeight: 500, color: C.orange }}>{fmt万(fire.requiredAnnualTax)} · {(fire.requiredMarginalTaxRate * 100).toFixed(0)}%</span>} />
      </Card>
