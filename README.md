...
TickTick 中 `在家routine` 和 `在校routine` 父任务树内未完成且已设日期的后代任务及 checklist 项，当前处于对应场景时会自动对齐今天，否则对齐下一段在家/在校的开始日；“学”和“实习”都视为在校。父任务标题中英文前后可以有空格，英文大小写不影响识别。日历中找不到下一段时，暂定到下一个春节。
